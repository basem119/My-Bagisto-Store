...
<x-shop::layouts
    ...
    :seo-description="trim($product->meta_description) != '' ? $product->meta_description : trim(strip_tags($product->description))"
    :seo-canonical="route('shop.product_or_category.index', $product->url_key)"
    seo-type="product"
    :seo-image="$productBaseImage['medium_image_url']"
    :seo-twitter-image="$productBaseImage['medium_image_url']"
>
    <!-- Page Title -->
    <x-slot:title>
