         ...
         <div class="flex w-[360px] max-w-full flex-col gap-2 max-sm:w-full">
            ...
            <x-admin::accordion>
               ...
               <div>
                  ...
                  @php
                  $additional = $order->payment->additional ?? null;
                  // additional قد تكون Array (cast) أو JSON String
                  ...
                  $paymobTxId = $additional['paymob_transaction_id'] ?? null;
                  @endphp
                  @if ($paymobTxId)
                  <div class="attribute-row">
                     <label>Paymob Transaction ID</label>
                     <p>{{ $paymobTxId }}</p>
                  </div>
                  @endif
                  <!-- Currency -->
                  ...
                  @endif
                  @if (!empty($additionalDetails['value']))
                  <p class="text-gray-600 dark:text-gray-300">
